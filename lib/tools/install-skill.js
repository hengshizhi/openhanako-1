  ...
  return {
    ...
    execute: async (_toolCallId, params) => {
      ...
      if (github_url?.trim()) {
        ...
        return {
          content: [{ type: "text", text: t("error.installSkillSuccess", { name, source: fetchedFrom, stars, reason }) }],
      ...
      return {
        content: [{ type: "text", text: t("error.installSkillSuccessLocal", { name, reason }) }],
